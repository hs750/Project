package HSProject.helicopterAgentSARSA;
...
public class HelicopterAgentSARSA implements AgentInterface {
	...
	public HelicopterAgentSARSA(double alpha, double gamma, double epsilon) {
   ...
   private Action egreedy(Observation theState) {
	...
	public static void main(String[] args) {
		...
		AgentLoader L = new AgentLoader(new HelicopterAgentSARSA(a, g, e));
		L.run();
	}
