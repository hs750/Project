...
public class TileCoding
{
	...
	public TileCoding(int numTiles, int numFeatures, int numTilings, double[] featureMin, double[] featureMax)
	{
	    //
	    nTiles_        = numTiles;
	    ...
	    for( int i=0; i<nFeatures_; i++ ) {
                   minimumValues_[i] = featureMin[i];
	        double range             = featureMax[i] - minimumValues_[i];
