package HSProject.tileCoded.helicopterAgentTileCodedHierarchicalQAgentPolicy;
 ...
 *
 */
public class HelicopterAgentTileCodedHierarchicalQAgentPolicy extends TileCodedAgentQ {
	...
	public static void main(String[] args) {
		AgentLoader L = new AgentLoader(new HelicopterAgentTileCodedHierarchicalQAgentPolicy());
		L.run();
	}
