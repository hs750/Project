...
/**
 * R. Koppejan and S. Whiteson, “Neuroevolutionary reinforcement learning for generalized control of simulated helicopters.,” Evol. Intell., vol. 4, no. 4, pp. 219–241, 2011.
 * @author harrison
 *
 */
public class StateManipulator9 implements StateManipulator {
	...
	public Observation manipulateState(Observation o) {
		...
		//Velocities
		newO.doubleArray[6] = o.doubleArray[6];
		newO.doubleArray[7] = o.doubleArray[7];
		newO.doubleArray[8] = o.doubleArray[8];
		return newO;
	}
