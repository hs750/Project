...
public class HelicopterAgentQDiscretised extends HelicopterAgentQ {
	private int aDesc;
	private int sDesc;
	public HelicopterAgentQDiscretised(double alpha, double gamma, double epsilon, int sDesc, int aDesc) {
	...
	public static void main(String[] args) {
		...
		AgentLoader L = new AgentLoader(new HelicopterAgentQDiscretised(a, g, e, d, d1));
		L.run();
	}
