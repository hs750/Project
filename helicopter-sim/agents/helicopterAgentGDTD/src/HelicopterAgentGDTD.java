package helicopterAgentGDTD.src;
...
public class HelicopterAgentGDTD implements AgentInterface {
	...
	public static void main(String[] args) {
		AgentLoader L = new AgentLoader(new HelicopterAgentGDTD());
		L.run();
	}
